...
# IMPORTANT — uses default_chat_model() (OpenAIChat), NOT default_model() (OpenAIResponses).
...
# See shared-results:programmatic-agent-4c-reasoning-result. Model id comes from
# app.settings.MODEL_ID (OPENAI_MODEL_ID env); base_url + key from OPENAI_BASE_URL/OPENAI_API_KEY.
